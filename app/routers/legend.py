...
from app.schemas import LegendCreate, LegendUpdate, LegendRead, LegendFilters, parse_legend_create, parse_legend_update
...
def get_all(filters: Annotated[LegendFilters, Depends()], user: User = Depends(AuthService.get_current_user)):
